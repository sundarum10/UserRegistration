...
SECRET_KEY = 'django-insecure-s-sxn07k2v=+1-y#is(jn14ieb(gn2!^r*5wmdn$^1o13f@95='
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=365*100),  # Set for 100 years
    'REFRESH_TOKEN_LIFETIME': timedelta(days=365*100),  # Set for 100 years
